...
#ifndef ST_PS_TEMPERATUREONEWIRE_H
#define ST_PS_TEMPERATUREONEWIRE_H
...
namespace st
{
	class PS_TemperatureOneWire public PollingSensor
	{
		private:
			byte m_nDigitalInputPin;		//digital pin connected to the DHT sensor
			int m_nTemperatureSensorValue;	//current Temperature value
			static ds OneWire;					//DHT library object
			byte m_bOneWireSensorType;			//DHT Sensor Type
		...
		public:
			...
			enum ONEWIRE_SENSOR { DS18S20, DS18B20, DS1822 };

			//constructor - called in your sketch's global variable declaration section
			PS_TemperatureOneWire(const __FlashStringHelper *name, unsigned int interval, int offset, byte digitalInputPin, ONEWIRE_SENSOR OneWireSensorType, String strTemp="temperature");
			
			//destructor
			virtual ~PS_TemperatureOneWire();
